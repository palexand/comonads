...
-- |The LV comonad consists of a list composed with a value.  In
-- |essence, it is an Id comonad with an added history.  This allows a
-- |stream processor constructed using LV to move through a collection
-- |of stream values.
